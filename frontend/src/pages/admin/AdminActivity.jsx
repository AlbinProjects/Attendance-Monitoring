  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-sm text-slate-muted -mt-2">
        Reflects browser activity plus privacy-safe desktop work activity — not a measure of productivity.
        No keystrokes, screenshots, window contents, URLs, source code, or document contents are collected. Click a row to see its inactivity periods.
      </p>
