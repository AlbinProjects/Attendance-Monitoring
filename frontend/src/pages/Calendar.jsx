          ...
          {days.map((d) => {
            ...
            return (
              <button
                ...
                className={`min-h-16 rounded-lg border p-1.5 text-left ${d.is_working_day ? "bg-white hover:border-brand" : "bg-slate-50 cursor-default"} ${isSelected ? "ring-2 ring-brand" : ""}`}
              >
