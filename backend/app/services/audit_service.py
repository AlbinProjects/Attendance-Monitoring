...
VALID_ACTIONS = {
    ...
    "ON_DUTY_STARTED",
    "ON_DUTY_ENDED",
    "ON_DUTY_DIRECT_GRANTED",
    "REMOTE_WORK_REQUESTED",
    "REMOTE_WORK_APPROVED",
    "REMOTE_WORK_REJECTED",
    "REMOTE_WORK_ASSIGNED",
    "REMOTE_WORK_UPDATED",
    "REMOTE_WORK_CANCELLED",
    "REMOTE_WORK_NOT_APPROVED",
    "BREAK_STARTED",
    "BREAK_ENDED",
    "SALARY_CALCULATION_CREATED",
    "SALARY_CALCULATION_UPDATED",
    "SALARY_BASE_UPDATED",
}
