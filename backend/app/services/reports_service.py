...
def generate_attendance_csv(
    ...
    *,
    ...
    header = ["Employee", "Department", "Date", "Check In", "Check Out", "Check-out Status", "Status", "Work Mode", "Work Location", "Source", "Break Time", "Active Time", "Inactivity"]
    rows = [
        [
            ...
            r.get("status") or "",
            "Work From Home" if r.get("work_mode") == "wfh" else "Other Site" if r.get("work_mode") == "other_site" else "Office",
