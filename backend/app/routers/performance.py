...
@router.get("/today")
async def get_today(employee: dict = Depends(require_role("employee", "admin"))):
    """
...
async def submit(
    ...
    employee: dict = Depends(require_role("employee", "admin")),
):
    """
...
@router.get("/missing")
async def get_missing(employee: dict = Depends(require_role("employee", "admin"))):
